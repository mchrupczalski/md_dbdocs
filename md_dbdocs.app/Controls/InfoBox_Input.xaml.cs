...
namespace md_dbdocs.app.Controls
{
    ...
    /// </summary>
    public partial class InfoBox_Input : UserControl
    {
        public InfoBox_Input()
        {
            InitializeComponent();
        }

        public static readonly DependencyProperty SetValueProperty = DependencyProperty.Register("SetBoxValue", typeof(string), typeof(InfoBox_Input), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnSetValueChanged)));
        ...
        {
            InfoBox_Input infoBox = d as InfoBox_Input;
        ...
        public static readonly DependencyProperty SetLabelProperty = DependencyProperty.Register("SetBoxLabel", typeof(string), typeof(InfoBox_Input), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnSetLabelChanged)));
        ...
        public static readonly DependencyProperty SetWidthProperty = DependencyProperty.Register("SetBoxWidth", typeof(double), typeof(InfoBox_Input), new PropertyMetadata(90D, new PropertyChangedCallback(OnSetWidthChanged)));
